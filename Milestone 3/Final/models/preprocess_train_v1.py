...
def train_save_w2_model(df, embedding_file, desc_lines, w2v_model_dir):
	...
	#h = model.fit(X_train2, y_train2, batch_size=32, epochs=10, validation_data=(x_val, y_val), verbose=2, shuffle=True)
	...
	#CR and CM::
	#y_pred = model.predict_proba(X_test2, batch_size=32, verbose=1)
